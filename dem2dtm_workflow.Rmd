...
source_url("https://github.com/andriizayac/uas_data_preprocess/blob/main/utils/merge_tiles_fn.R?raw=TRUE")

# specify paths
path_prj <- "path/to/dense/cloud"
...
while(length(lf) < length(list.files(gsub("/tile", "/tmp/tile", lf), pattern = "\\].las$"))) {
  Sys.sleep(10)
