...
```{r}
# CloudCompare command
cmd <- paste0("FOR %f IN (", wdir, "*_SOR_FILTERED_*.bin) DO \"C:/Program Files/CloudCompare/cloudcompare.exe\" -SILENT -O -GLOBAL_SHIFT AUTO %f -AUTO_SAVE OFF -CURV NORMAL_CHANGE 0.05 -NO_TIMESTAMP -C_EXPORT_FMT BIN -SAVE_CLOUDS")
...
A reverse step that combines all tiles into a single *.las* file for final steps in CloudCompare GUI.
