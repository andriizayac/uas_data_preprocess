...
# load packages
pkgs <- c("lidR", "raster", "sf", "stars", "terra", "tidyverse")
...
tout |> 
  filter(treeID %in% cout$treeID) |>
    st_write(paste0(path_prj, "/segment_output/", site, "_ttops.shp"), delete_layer = TRUE)

cout |> 
    st_write(paste0(path_prj, "/segment_output/", site, "_crown.shp"), delete_layer = TRUE)

writeRaster(cro, filename = paste0(path_prj, "/segment_output/", site, "_crown_raster.tif"), overwrite = TRUE)
```
---
