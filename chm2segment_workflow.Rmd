...
# load packages
pkgs <- c("lidR", "raster", "sf", "stars", "terra", "tidyverse", "ggplot2")
...
writeRaster(cro, filename = paste0(path_prj, "/segment_output/", site, "_crown_raster_cloud.tif"), overwrite = TRUE)
```
